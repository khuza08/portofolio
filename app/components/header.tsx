...
export default function Header() {
  ...
  <Link href="#about" className={`hover:text-yellow-300 transition ${
    activeSection === "about" ? "text-purple-600 drop-shadow-[0_0_8px_rgba(191,191,255,0.9)]" : ""
  }`}>
    About
  </Link>
  <Link href="#education" className={`hover:text-yellow-300 transition ${
    activeSection === "education" ? "text-purple-600 drop-shadow-[0_0_8px_rgba(191,191,255,0.9)]" : ""
  }`}>
    Education
  </Link>
  <Link href="#skills" className={`hover:text-yellow-300 transition ${
    activeSection === "skills" ? "text-purple-600 drop-shadow-[0_0_8px_rgba(191,191,255,0.9)]" : ""
  }`}>
    Skills
  </Link>
  <Link href="#project" className={`hover:text-yellow-300 transition ${
    activeSection === "project" ? "text-purple-600 drop-shadow-[0_0_8px_rgba(191,191,255,0.9)]" : ""
  }`}>
    Project
  </Link>
</nav>
