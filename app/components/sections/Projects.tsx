...
export function Projects() {
  const projects = [
    {
      title: "XII RPL-1 (WIP)",
      image:
        "https://github.com/khuza08/webrpl1/blob/dev-huza/src/lib/assets/img/Screenshot%202025-08-14%20203523.png?raw=true",
      description:
        "Website resmi kelas XII RPL-1 generasi ke-8, menampilkan profil, kegiatan, dan dokumentasi kelas dengan desain modern.",
      tech: "Svelte",
      techColor: "orange",
    ...
    },
    {
      ...
      image:
        "https://github.com/khuza08/web_antrek2/blob/main/src/assets/images/image.png?raw=true",
      description:
        "Website sekolah yang dikembangkan untuk JHIC 2025 (Jagoan Hosting Infra Competition), menampilkan informasi sekolah, berita, dan galeri.",
      tech: "React",
      techColor: "yellow",
      github: "https://github.com/Adityanrhm/kas-management",
      gradientColor: "from-yellow-600 via-yellow-500 to-yellow-400",
    },
    {
      ...
      image:
        "https://raw.githubusercontent.com/Adityanrhm/kas-management/dev/overview/login.png",
      description:
        "Aplikasi manajemen kas kelas untuk mencatat transaksi, mengatur anggaran, dan menghasilkan laporan keuangan secara otomatis.",
      tech: "Laravel",
      techColor: "red",
      github: "https://github.com/Adityanrhm/kas-management",
  ...
  const ProjectCard = ({ project, index }) => {
    ...
    return (
      <div
        className="relative bg-white/5 border border-white/10 rounded-2xl overflow-hidden group hover:bg-white/10 hover:border-white/20 transition-all duration-300 flex flex-col h-full"
        data-aos="fade-up"
        data-aos-delay={index * 150} // animasi delay buat tiap card beda
      >
        <div
          className={`absolute bottom-[-16px] left-0 w-16 h-16 rounded-full bg-gradient-to-r ${project.gradientColor} opacity-100 blur-3xl pointer-events-none`}
        />
    ...
    >
      <div className="max-w-6xl w-full">
        ...
        <p className="text-center text-white/65 italic" data-aos="fade-up" data-aos-delay="100">
          stuff that i cooked when im bored
        </p>
